...
import com.nostratech.moviecatalog.security.model.AnonymousAuthentication;
...
public class JWTAuthProcessingFilter extends AbstractAuthenticationProcessingFilter {
	...
	public Authentication attemptAuthentication(
		...
		String jwtToken = tokenExtractor.extract(authorizationHeader);
		
		RawAccessJWTToken rawToken = new RawAccessJWTToken(jwtToken);
